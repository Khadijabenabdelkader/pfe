...
const addFormateur = (req, res) => {
  ...
  /*const domaineCompetencesJson = Array.isArray(domaine_de_competences) ? JSON.stringify(domaine_de_competences) : JSON.stringify([]);
    const themesAEnseignerJson = Array.isArray(themes_a_enseigner) ? JSON.stringify(themes_a_enseigner) : JSON.stringify([]);
*/}
{/*
